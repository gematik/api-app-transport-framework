...
* #eRezept_Rezeptanforderung;Rezeptanfrage;nur_Ausstellen "Anfrage an einen Arzt ein Rezept auszustellen" // Empfänger schickt das Rezept zurück
* #eRezept_Rezeptanforderung;Rezeptanfrage;weiterleiten_an_Apotheke "Anfrage an einen Arzt ein Rezept auszustellen und das Rezept an die Apotheke weiterzuleiten" // Sender schickt auch einen DispenseRequest mit, der weitergeleitet werden soll
* #eRezept_Rezeptanforderung;Rezeptanfrage;Storno "Abbruch der Rezeptanfrage"
...
* #eRezept_Rezeptanforderung;Abgabeanfrage;Storno "Abbruch der Rezeptanfrage"
